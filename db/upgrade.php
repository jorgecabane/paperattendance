...
function xmldb_local_paperattendance_upgrade($oldversion) {
	...
	if ($oldversion < 2017053001) {
		...
		$table = new xmldb_table('paperattendance_unprocessed');
		$field = new xmldb_field('uploaderid', XMLDB_TYPE_INTEGER, '20', null, XMLDB_NOTNULL, null, null, 'lastmodified');
		...
		// Paperattendance savepoint reached.
		upgrade_plugin_savepoint(true, 2017053001, 'local', 'paperattendance');
	}
